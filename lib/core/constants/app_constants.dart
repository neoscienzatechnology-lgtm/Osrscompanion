...
class AppConstants {
  ...
  // API Endpoints
  static const String osrsGeApiBase = 'https://secure.runescape.com/m=itemdb_oldschool';
  static const String osrsWikiApi = 'https://oldschool.runescape.wiki/api.php';
  ...
  // Ad Configuration
  static const int interstitialAdFrequency = 10; // Show every 10 navigations
  ...
  // Skill IDs
  static const List<String> skillIds = [
  ...
  // Quest Difficulties
  static const List<String> questDifficulties = [
    'novice', 'intermediate', 'experienced', 'master', 'grandmaster'
  ];
  
  // Quest Lengths
  static const List<String> questLengths = [
